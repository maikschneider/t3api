...
class SerializerService implements SingletonInterface
{
    ...
    {
        return FileUtility::createWritableDirectory(Environment::getVarPath() . '/cache/code/t3api_serializer/jms-serializer');
    }
    ...
    {
        return FileUtility::createWritableDirectory(Environment::getVarPath() . '/cache/code/t3api_serializer/jms-metadir');
    }
